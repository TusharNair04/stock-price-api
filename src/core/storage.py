...
from .models import HistoricalBar, Quote
...
def save_quote(quote: Quote, filename: str | None = None) -> Path:
    """
...
def save_quotes(quotes: list[Quote], filename: str | None = None) -> Path:
    """
...
def load_quotes(filename: str | None = None) -> list[Quote]:
    """
...
def get_latest_quote_for_ticker(ticker: str) -> Quote | None:
    """
